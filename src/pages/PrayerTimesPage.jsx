...
function PrayerTime({ onNavigate }) {
  ...
  const getLocationAndFetch = () => {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          message.warning(
            "GPS access denied/failed. Using default location (Jakarta).",
          );
          const defLat = -6.2088;
  ...
  const getIcon = (name) => {
    switch (name) {
      case "Fajr":
        return <WiMoonAltWaxingCrescent4 size={28} color={THEME_COLOR} />;
      case "Sunrise":
        return <SunFilled style={{ fontSize: 24, color: "#faad14" }} />;
      case "Dhuhr":
        return <WiDaySunny size={32} color="#faad14" />;
      case "Asr":
        return <CloudFilled style={{ fontSize: 24, color: "#8c8c8c" }} />;
      case "Maghrib":
        return (
          <div
            style={{
              width: 24,
              height: 12,
              background: "linear-gradient(to top, #faad14, #1B4D3E)",
              borderRadius: "12px 12px 0 0",
            }}
          ></div>
        );
      case "Isha":
        return <MoonFilled style={{ fontSize: 24, color: THEME_COLOR }} />;
      default:
                ...
                >
                  ...
                  <div style={{ position: "relative", zIndex: 1 }}>
                    ...
                    <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
                      ...
                      >
                        <CalendarOutlined
                          style={{ color: ACCENT_COLOR, fontSize: 18 }}
                        />
                        <div>
                          <Text
                            style={{
                          ...
                          >
                            ...
                            >
                              ...
                              <div>
                                <Text
                                  ...
                                  style={{
                                    fontSize: 16,
                                    color: isActive ? THEME_COLOR : "#333",
                                  }}
                                >
                                  {name}
                                </Text>
                            ...
                            <Text
                              style={{
                                ...
                                color: isActive ? THEME_COLOR : "#555",
                              }}
                            >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Text
                          strong
                          style={{ fontSize: 18, color: THEME_COLOR }}
                        >
                          {Math.round(qiblaDir)}°
                        </Text>
                      </div>
